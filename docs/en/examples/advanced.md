    ...
    case 'logs':
      return c.json({
        ...
        logs: [
          ...
          { level: 'warn', message: 'High memory usage', timestamp: '2024-01-01T01:00:00Z' }
        ],
        user
      })
...
const collections: Record<string, any[]> = {
  products: [
    ...
    { id: 2, name: 'Phone', category: 'electronics', status: 'active', price: 599 },
    { id: 3, name: 'Book', category: 'books', status: 'inactive', price: 29 },
    { id: 4, name: 'Tablet', category: 'electronics', status: 'active', price: 399 },
...
- [Project Examples](./projects.md) - Complete project setups
