...
export const GET = async (c: Context) => {
	return c.json({
		...
		version: '1.0.0',
		features: ['基于文件的路由', 'TypeScript 支持', '热重载', '自动路由生成'],
	})
}
```
...
- [高级示例](/zh/examples/advanced.md) - 复杂路由模式
- [项目示例](/zh/examples/projects.md) - 完整项目设置
- [最佳实践](/zh/examples/best-practices.md) - 推荐模式
