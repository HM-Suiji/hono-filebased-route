...
export const GET = (c: Context) => {
  ...
  return c.json({
    ...
    subcategory,
    items: [
      { id: 1, name: `${category}/${subcategory} 中的项目` }
    ]
  })
}
```
...
1. 学习[动态路由](/zh/guide/dynamic-routes)了解高级参数处理
2. 探索[高级功能](/zh/guide/advanced-features)了解中间件和钩子
3. 查看 [API 参考](/zh/reference/)获取完整文档
